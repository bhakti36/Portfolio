...
const Contact = () => {
  const handleSubmit = (e) => {
    ...
    emailjs.sendForm('service_d8m662h', 'template_hh60zn9', e.target, 'JfxD3_FWKBdBBrl9R')
      .then((result) => {
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
        ...
        <div className="flex flex-col md:flex-row md:space-x-12">
          <div className="flex-1 mb-8 md:mb-0">
            ...
            <p className="text-base md:text-lg">With 8+ years of experience in full-stack development and cloud solutions, and my last role as an Application Development Team Lead, I am always open to discussing innovative projects, leadership opportunities, and industry collaborations. Let’s connect and explore how we can create impactful solutions together!</p>
            <div className='mb-4 mt-8'>
                <FaEnvelope className='inline-block text-green-400 mr-2' />
                <a href="mailto:bhakti.rock91@gmail.com" className='hover:underline text-green-400'>
                bhakti.rock91@gmail.com
                </a>
            </div>
            <div className='mb-4'>
                <FaPhone className='inline-block text-green-400 mr-2' />
                <span>+1 424 448 9797</span>
            </div>
            <div className='mb-4'>
                <FaMapMarkedAlt className='inline-block text-green-400 mr-2' />
                <span>Worcester, Massachusetts , US</span>
            </div>
          </div>
