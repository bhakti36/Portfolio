...
const achievements = [
  {
    title: 'Recognition for Outstanding Performance & Automation',
    description: 'Automated deployment processes and streamlined the CI/CD pipeline using Jenkins, later transitioning to Azure for improved efficiency. Integrated a new module into the Product Information Management (PIM) system, enabling seamless third-party API integrations, enhancing system capabilities.',
